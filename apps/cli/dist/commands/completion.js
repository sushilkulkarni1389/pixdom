...
function generateFishCompletionScript() {
    const lines = [
        ...
        ...FORMAT_VALUES.map((v) => `complete -c pixdom -n "__fish_seen_subcommand_from convert" -l format -r -a "${v}" -d "Output format"`),
        '',
        '# convert --profile values',
        ...PROFILE_SLUGS.map((v) => `complete -c pixdom -n "__fish_seen_subcommand_from convert" -l profile -r -a "${v}"`),
        '',
