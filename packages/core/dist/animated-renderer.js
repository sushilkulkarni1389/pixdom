 ...
 */
export async function captureFrames(page, cycleMs, fps, outDir) {
...
function ffmpegEncode(inputPattern, fps, outputPath, extraArgs) {
...
export async function encodeGif(frames, fps, _cycleMs) {
...
export async function encodeMp4(frames, fps) {
    assertFfmpegAvailable();
...
export async function encodeWebm(frames, fps) {
    assertFfmpegAvailable();
...
export async function renderAnimated(page, options, cycleMs) {
