...
export const LINKEDIN_BACKGROUND: Profile = Object.freeze({
  id: 'linkedin-background' as const,
  width: 1584,
  height: 396,
...
export const LINKEDIN_POST: Profile = Object.freeze({
...
export const LINKEDIN_ARTICLE_COVER: Profile = Object.freeze({
  id: 'linkedin-article-cover' as const,
  width: 2000,
  height: 600,
  format: 'jpeg' as const,
  quality: 85,
...
export const LINKEDIN_PROFILE: Profile = Object.freeze({
  id: 'linkedin-profile' as const,
  width: 800,
  height: 800,
  format: 'jpeg' as const,
  quality: 90,
...
export const LINKEDIN_SINGLE_IMAGE_AD: Profile = Object.freeze({
  id: 'linkedin-single-image-ad' as const,
  width: 1200,
  height: 627,
  format: 'jpeg' as const,
  quality: 85,
...
export const LINKEDIN_CAREER_BACKGROUND: Profile = Object.freeze({
  id: 'linkedin-career-background' as const,
  width: 1128,
  height: 191,
  format: 'jpeg' as const,
  quality: 85,
...
export const TWITTER_POST: Profile = Object.freeze({
...
export const TWITTER_HEADER: Profile = Object.freeze({
  id: 'twitter-header' as const,
  width: 1500,
  height: 500,
  format: 'jpeg' as const,
  quality: 85,
...
export const TWITTER_AD: Profile = Object.freeze({
  id: 'twitter-ad' as const,
  width: 1600,
  height: 900,
  format: 'jpeg' as const,
  quality: 85,
...
export const TWITTER_VIDEO: Profile = Object.freeze({
  id: 'twitter-video' as const,
  width: 1600,
  height: 900,
  format: 'mp4' as const,
  quality: 85,
...
export const TWITTER_AD_LANDSCAPE: Profile = Object.freeze({
  id: 'twitter-ad-landscape' as const,
  width: 800,
  height: 450,
  format: 'mp4' as const,
  quality: 85,
...
export const INSTAGRAM_POST_3_4: Profile = Object.freeze({
  id: 'instagram-post-3-4' as const,
  width: 1080,
  height: 1440,
  format: 'jpeg' as const,
  quality: 90,
...
export const INSTAGRAM_POST_4_5: Profile = Object.freeze({
  id: 'instagram-post-4-5' as const,
  width: 1080,
  height: 1350,
  format: 'jpeg' as const,
  quality: 90,
...
export const INSTAGRAM_POST_SQUARE: Profile = Object.freeze({
  id: 'instagram-post-square' as const,
  width: 1080,
  height: 1080,
  format: 'jpeg' as const,
  quality: 90,
...
export const INSTAGRAM_STORY: Profile = Object.freeze({
...
export const INSTAGRAM_REEL: Profile = Object.freeze({
...
export const INSTAGRAM_PROFILE: Profile = Object.freeze({
  id: 'instagram-profile' as const,
  width: 320,
  height: 320,
  format: 'jpeg' as const,
  quality: 90,
...
export const INSTAGRAM_STORY_VIDEO: Profile = Object.freeze({
  id: 'instagram-story-video' as const,
  width: 1080,
  height: 1920,
  format: 'mp4' as const,
  quality: 85,
...
const ALIAS_MAP: Partial<Record<ProfileId, string>> = {
  instagram: 'instagram-post-square',
  twitter: 'twitter-post',
  linkedin: 'linkedin-post',
};

export function resolveProfile(slug: ProfileId): Profile {
...
export function groupedProfiles(): Record<string, Profile[]> {
